...
- `src/jarvis_run_coordinator/clients/selection_client.py` (reserved; not used by coordinator logic in v0.3.5)
...
- `JARVIS_SELECTION_URL` (reserved; coordinator does not call Selection in v0.3.5)
...
- `JARVIS_RUN_COORDINATOR_AUTO_DISPATCH` (default true; if false, NodeRuns remain queued in v0.3.5)
